        ...
        handleChange(event) {
            switch (event.target.name) {
                case "name":
                    ...
                    // if at least one thing is changed and it is not empty the hero can be edited
        ...
        return ( 
            <div id='hero-info' className='edit-hero'>
                <div className='nav-buttons'>
                    <div>
                        <Link to={`/FehSingle/${this.id}`}><img src={this.back} alt='Go back to the main page'></img></Link>
                    </div>
                </div>
                {
                ...
                <img className='heroImg' src={this.state.heroIsKnown ? require(`../assets/img/heroes/${this.state.heroId + ".png"}`).default : require(`../assets/img/heroes/unknown.png`).default } alt={this.state.heroIsKnown ? `${this.state.name}'s full art` : "default image"}></img>
